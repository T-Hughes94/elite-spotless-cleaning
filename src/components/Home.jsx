...
//         backgroundSize: 'contain', // Adjust the background size here
  ...
  return (
    ...
    >
      <div className="bg-white/70 p-8 rounded-lg shadow-lg max-w-3xl text-center mx-4 md:mx-auto">
        ...
        <button
          className="px-6 py-3 mt-8 bg-gray-950 text-white rounded-lg hover:bg-[#94c2d2] transition duration-300"
