...
function QuoteForm() {
  ...
  const sendEmails = async (templateParams, estimatedQuoteValue) => {
    try {
      // Deliberately using incorrect service ID for testing error handling
      ...
      <div id="quote" className="max-w-[1040px] mx-auto p-4 bg-[#94c2d2] shadow-lg rounded-lg">
        ...
        {!showConfirmation ? (
          ...
          <div className='text-center'>
            ...
            <p className='py-4'>
             contact you shortly to  We have received your submission and will confirm the details and schedule your cleaning.
            </p>
            <p className='py-4'>
