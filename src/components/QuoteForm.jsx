...
//   useEffect(() => {
//     emailjs.init(import.meta.env.VITE_EMAILJS_PUBLIC_KEY); // Use environment variable
//   }, []);
...
//               </div>
//               <div className='flex flex-col'>
//                 <label className='uppercase text-sm font-semibold py-2'>Additional Info</label>
//                 <textarea
//                   className='border-2 rounded-lg p-3 border-gray-300 focus:border-[#001b5e] focus:ring-[#001b5e]'
//                   name='additionalInfo'
//                   value={formState.additionalInfo}
...
//               <button type='submit' className='bg-[#001b5e] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#00103a] transition duration-300'>
//                 Get Quote
//               </button>
//             </div>
//           </form>
//         ) : (
//           <div className="text-center">
//             <h2 className="text-2xl font-bold text-[#030712]">Thank you for your request!</h2>
//             <p className="mt-4 text-lg">Your estimated quote is: {estimatedQuote}</p>
//           </div>
//         )}
//       </div>
//     </div>
